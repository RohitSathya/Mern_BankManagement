...
export default function transaction({data1,data2}) {
   ...
   const [bal,setBalance]=useState()
    ...
    async function transfer(){
        ...
        const response=await axios.post('https://bank-mernbackend-68pw3t8e7-rohits-projects-a5c6d24a.vercel.app/api/transaction/transfer',{type:'transfer',fromaccountno:parse.accountno,toaccountno:data2,amount:amount})
