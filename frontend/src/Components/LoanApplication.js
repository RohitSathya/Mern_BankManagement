...
const LoanApplicationComponent = ({data}) => {
  ...
  const submitApplication = async () => {
     ...
     const res=await axios.post('https://bank-mernbackend-68pw3t8e7-rohits-projects-a5c6d24a.vercel.app/api/transaction/apply-loan',{userId:parse.accountno,loanAmount:loanAmount,durationMonths:duration,name:name,balance:data})
